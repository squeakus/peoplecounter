...
def parse_args():
    ...
    parser.add_argument("-cnn", "--cnn_model", default="mobilenet-ssd", type=str, choices=("mobilenet-ssd"),
                        help="Cnn model to run on DepthAI")
    
    parser.add_argument("-cnn2", "--cnn_model2", default="", type=str, choices="mobilenet-ssd",
